...
public class Note implements MusicElement, DurationElement {
    ...
    /**
     * Convert the note to a JFugue string representation
     * Implementation of the abstract method from MusicElement interface
     * @return String representation of the note in JFugue format
     */
    @Override
